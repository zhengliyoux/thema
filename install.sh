...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY OLIVIA DEVELOPER           [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  ...
  if [ "$USER_TOKEN" = "olivia" ]; then
    ...
    echo -e "${GREEN}Buy dulu Gih Ke OliviaDevz${NC}"
    echo -e "${YELLOW}TELEGRAM : @greyskydrift${NC}"
    echo -e "${YELLOW}WHATSAPP : 62882016523845${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 10K FREE UPDATE JIKA ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}©oliviadeveloper${NC}"
    exit 1
  fi
  clear
}
...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://github.com/zhengliyoux/thema/raw/main/C2.zip")
        break
        ;;
      2)
        ...
        ;;
      3)
        THEME_URL=$(echo -e "https://github.com/zhengliyoux/thema/raw/main/C3.zip")
        break
        ;; 
      x)
        return
...
# Unduh file tema
wget -O /root/C2.zip https://github.com/zhengliyoux/thema/raw/main/C2.zip
...
while true; do
  ...
  echo -e "${WHITE} ggg:     ggg._    _,ggg        • Credit  : OliviaBotz ${NC}"
